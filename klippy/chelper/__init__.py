...
defs_kin_backlash = """
    ...
    int backlash_set_sk(struct stepper_kinematics *sk
        , struct stepper_kinematics *orig_sk);
    void backlash_set_backlash(struct stepper_kinematics *sk
        , int axis, double backlash);
    void backlash_set_position(struct stepper_kinematics *sk
        , double x, double y, double z);
"""
...
defs_all = [
    ...
    defs_kin_generic_cartesian, defs_kin_backlash,
]
